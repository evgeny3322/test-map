    ...
    const vdnhAreas = [
      ...
      // Обновленный объект музея космонавтики с точными координатами из GeoJSON
      {
        ...
        shape: {
          type: 'polygon',
          coordinates: [
            [37.62020145842044, 55.83582377658277],
            [37.62195992346034, 55.83473789806419],
            [37.62246334640682, 55.83500091049223],
            [37.620666039702655, 55.836073644824324],
            [37.62015084070785, 55.83579595606196]
          ],
          style: {
            fillColor: '#3F51B5',
            strokeColor: '#3F51B5',
